...
export default class YouTubeComments extends Component {
  static propTypes = {
  ...
  constructor(props) {
    super(props);
    this.youtubeCommentsNode = React.createRef();
  ...
  componentDidMount() {
    ...
    this.youtubeCommentsNode.current.parentNode.appendChild(youtubescript);
    this.initialized();
  }
  ...
  render() {
    ...
    return (
      <section className="youtubeComments">
        <div
          ref={this.youtubeCommentsNode}
          className="g-ytcomments"
          data-theme={theme}
          data-layout={layout}
          data-count={count}
